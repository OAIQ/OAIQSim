function Z = NPP(lambda,N,dim,domain,ub,os)
    % This function is a non-random point process.  A rejection sampler is
    % used to sample N points from the function lambda.
